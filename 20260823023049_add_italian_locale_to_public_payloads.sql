...
-- Reconhece o italiano nos payloads públicos e devolve somente a tradução/
-- legenda do idioma solicitado, mantendo o mesmo isolamento usado por ES/FR.
  ...
  select jsonb_build_object(
    ...
    'data', jsonb_strip_nulls(jsonb_build_object(
      ...
      'subtitleUrl', case p.locale
        ...
        when 'it' then nullif(c.data #>> '{subtitleTracks,it}', '')
        else null
      end,
      ...
      'translations', case
        ...
        when p.locale in ('es','fr','it') and c.data -> 'translations' -> p.locale is not null

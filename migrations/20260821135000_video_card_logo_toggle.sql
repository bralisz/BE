...
-- Expõe a preferência showCardLogo dos vídeos no payload público sem alterar
-- o comportamento existente de filmes/séries, legendas por idioma ou Smart TV.
...
as $function$
  ...
  select jsonb_build_object(
    ...
    'data', jsonb_strip_nulls(jsonb_build_object(
      ...
      'showCardLogo', c.data -> 'showCardLogo',
      'slug', c.data -> 'slug',
...
is 'Locale-aware public content payload with video card-logo preference, existing movie/series subtitle tracks and Smart TV Drive fallback.';

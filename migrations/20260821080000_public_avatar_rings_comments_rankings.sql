...
-- Expõe somente a cor pública do aro junto dos comentários.
...
-- Inclui a mesma cor pública do aro no ranking sem abrir as demais preferências.
  ...
  select jsonb_build_object(
    ...
    'profileRanking', coalesce((
      select jsonb_agg(jsonb_build_object(
        ...
        'avatarBorderColor', pr.avatar_border_color,

    ...
    return `<div class="content-editor-fields">
      <section class="editor-field-group">
        ...
        <div class="form-grid modern-form-grid">
          ...
          <div class="field full"><label>Descrição <small style="display:block;margin-top:5px;color:var(--a-muted);font-weight:500">Markdown habilitado: **negrito**, *itálico*, listas e links.</small></label><textarea class="a-textarea" rows="5" maxlength="1000" name="description" placeholder="Escreva uma descrição curta para o site">${esc(item.description || '')}</textarea><div class="field-counter"><span data-description-count>0</span>/1000</div></div>
        </div>
      </section>
